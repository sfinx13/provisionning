...
ansible-playbook -v -i inventory.ini playbooks/initial-setup.yml --ask-pass
...
ansible-playbook -v -i inventory.ini playbooks/install-composer.yml
...
ansible-playbook -v -i inventory.ini playbooks/install-mysql.yml
